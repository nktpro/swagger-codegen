...
declare module "superagent" {
  ...
  type CallbackHandler = { (err: any, res: Response): void; } | { (res: Response): void; };
  ...
  var request: SuperAgentStatic;

  export interface SuperAgent<Req extends Request<any>> extends stream.Stream {
  ...
  export interface Request<Req extends Request<any>> /* extends NodeJS.WritableStream */ {
    abort(): void;
